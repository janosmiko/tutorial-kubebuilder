...
import (
	...
	janosmikocomv1alpha1 "github.com/janosmiko/tutorial-kubebuilder/api/v1alpha1"
	"github.com/janosmiko/tutorial-kubebuilder/internal/controller"
...
func init() {
	...
	utilruntime.Must(janosmikocomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(
		ctrl.GetConfigOrDie(), ctrl.Options{
			...
			LeaderElectionID:       "1e00d489.tutorial.janosmiko.com",
	...
	if err = (&controller.DomainResolverReconciler{
		...
		// Inject the logger, recorder and tracer
